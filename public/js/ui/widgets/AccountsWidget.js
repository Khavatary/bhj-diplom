...
class AccountsWidget {
   ...
   * */
  registerEvents() {
    const clcBtn = document.querySelector(`.accounts-panel`);
    clcBtn.addEventListener(`click`, (e) => {
      e.preventDefault();
  ...
  onSelectAccount(element) {
    const activ = document.querySelector(`li.active`);
    if (activ) {
   ...
   * */
  renderItem(data) {
    const masAcc = document.querySelector(`.accounts-panel`);
    data.forEach(item => masAcc.insertAdjacentHTML(`beforeend`, this.getAccountHTML(item)));
  }
}